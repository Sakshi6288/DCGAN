...
## Creating an Easydict object and assigning it to cfg..
__C = edict()
cfg = __C

## In this configuration file we are defining path to the dataset and hyperparameters which will allow users to easily customize the model behavior without modifying the source code..

# Dataset name: flowers, birds
#__C.DATASET_NAME = 'birds'
#__C.CONFIG_NAME = ''
__C.DATA_DIR = r'C:/Users/ANNA MANI/Desktop/Sakshi_mixnmatch/cvat_tanks_5675'
#__C.SAVE_DIR = ''
__C.GPU_ID = '0'
#__C.CUDA = True
...
__C.TRAIN.FIRST_MAX_EPOCH = 950
__C.TRAIN.SECOND_MAX_EPOCH = 650
