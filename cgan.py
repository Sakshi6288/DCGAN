...
dataloader = torch.utils.data.DataLoader(
    datasets.ImageFolder(
        r"C:\Users\ANNA MANI\SquaretoGAN\data",
        transform=transforms.Compose(
            [transforms.Resize((256,256), interpolation=Image.BILINEAR), transforms.ToTensor(), transforms.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5])]
        ),
    ),
...
test_images = generator(test_noise, labels=None)
